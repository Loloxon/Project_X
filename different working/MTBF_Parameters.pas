...
Main functionality:
The main MTBF_AddComponentUserParameters procedure reads config file line by line and than for each parameter found scans current design for SchDoc document.
...
2. Config line example:
   ...
   in its ALTIUM decription field. Also will set its value to second string ('Capacitor' in this example).
...
3. Config lines example:
   ...
   After processing of these two lines, component U21 (if found) will receive parameter RS_CATT = 'Microprocessor, Digital',
   and  RS_NMBR_BITS = 16
   ('*' symbols are converted into spaces). Also visibility for these parameters is set to 'OFF'.
...
5. Config line example:
   '???' 'RS_CATT' 'any' 'any' generates report for any component checking if given parameter name is set and/or contains '?'.
...
{======================================================================================================================================================}
// Raport utility - logs all categories and their values for all components
{======================================================================================================================================================}
                               ...
                               begin
                                   ...
                                   if (Parameter_Array.Count = 4 ) then
                                      ...
                                      if(NextComponent = true) then
                                         ...
                                         WriteLogFileMessage(TxTMessage);
                                         TxTMessage := '#' + chr(9) + chr(9) + 'Parameter:' + ComponentPAR[RS_PAR_NAME]; // why '#' ?
                                         WriteLogFileMessage(TxTMessage);
                                         end
                                      else
                                         begin
...
Begin
    ...
    Begin
        ...
        End;
    End;
    ShowInfo ('Deletig parameters with name prefix:' + '''' + ParamPrefix + '''' + ' done');
    Exit;
End;
{======================================================================================================================================================}
{======================================================================================================================================================}
